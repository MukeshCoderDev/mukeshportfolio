...
const Contact: React.FC = () => {
  ...
  const { sendEmail, isSending, isSent, error } = useEmailService();
            ...
            <form onSubmit={handleSubmit}>
              <div className="space-y-6">
                <input
                  ...
                  className={`w-full px-5 py-3 bg-slate-800/50 border ${
                ...
                <button
                  type="submit"
                  disabled={isSending}
                  className={`inline-block text-white font-semibold text-lg py-3 px-10 rounded-full bg-gradient-to-r from-[#6a11cb] to-[#2575fc] ${
                    isSending
